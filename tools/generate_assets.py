...
def save_player_walk():
    ...
    for i in range(frames):
        ...
        for x in range(10, 23):
            if img.get(ox + x, 31)[3] != 0:
                img.set(ox + x, 31, outline)
...
def save_buildings():
    ...
    for i in range(7):
        ...
        for by in range(base_y + 6, base_y + h - 30, 24):
            img.rect(x + 38, by + 14, 33, 4, (124, 62, 42, 255))

        img.rect(x + 20, 74 - (h - 160), 8, 6, (40, 40, 54, 255))
        img.rect(x + 80, 70 - (h - 160), 7, 10, (32, 32, 46, 255))
